...
export default function RegionChart() {
  ...
  const options = {
    ...
    scales: {
      y: { beginAtZero: true, grid: { color: "#e5eaf0" }, ticks: { color: "#4a6080" } },
  ...
  return (
    <div style={{ backgroundColor: "white", borderRadius: "8px", padding: "28px 32px", marginBottom: "24px", boxShadow: "0 1px 4px rgba(0,0,0,0.08)" }}>
      <h2 style={{ margin: "0 0 6px", fontSize: "16px", fontWeight: 600, color: "#1e3a5f" }}>지역별 평균 가용병상 수</h2>
      <p style={{ margin: "0 0 20px", fontSize: "13px", color: "#7a90a8" }}>가용병상이 적을수록 응급의료 공백 위험이 높습니다</p>
